    ...
    return (
      <div className="min-h-screen bg-black flex items-center justify-center">
        <div className="text-center">
          ...
          <div className="text-primary text-xl uppercase tracking-tighter">CARREGANDO...</div>
        </div>
      </div>
    );
  }
            ...
            return (
              ...
              >
                <div className="relative w-14 h-14 flex-shrink-0">
                  <div className="w-full h-full rounded-lg overflow-hidden border-[3px] border-gray-700 bg-dark-200 flex items-center justify-center group-hover:border-primary/50 transition-colors">
                    {logoUrl ? (
                      <img 
                        src={logoUrl} 
                        alt={neg.nome} 
                ...
                <div className="flex-1 min-w-0">
                  ...
                  {negocios.length > 0 && (
                    <div className="text-xs text-gray-500 uppercase mt-0.5">{neg.tipo_negocio || 'Negócio'}</div>
                  )}
                  {neg.endereco && (
