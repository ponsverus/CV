    ...
    <div className="space-y-6">
      ...
      <div className="bg-dark-200 border border-gray-800 rounded-custom p-5">
        ...
        <div className="mt-2 bg-dark-100 border border-gray-800 rounded-custom p-4">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-end gap-3 mb-3"><MesSelect value={faturamentoMes} onChange={setFaturamentoMes} todayISO={hoje} /></div>
